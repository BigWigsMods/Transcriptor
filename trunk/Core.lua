...
L:RegisterTranslations("zhTW", function() return {
	["Start"] = "開始",
	["Start transcribing."] = "開始記錄戰鬥",
	["Stop"] = "停止",
	["Stop transcribing."] = "停止記錄",
	["Insert Note"] = "筆記",
	["Insert a note into the currently running transcript."] = "為記錄中的戰鬥文字加上筆記",
	["Events"] = "事件",
	["Toggle which events to log data from."] = "選擇要記錄數據的事件",
	["Time format"] = "時間格式",
	["Change the format of the log timestamps (epoch is preferred)."] = "改變記錄的時間格式",
	["Clear Logs"] = "清除記錄",
	["Clears all the logged data from the Saved Variables database."] = "清空所有戰鬥紀錄",
	["Toggle logging of %s."] = "切換 %s 的記錄",
	["You are already logging an encounter."] = "你已經準備記錄戰鬥",
	["Skipped Registration: "] = "跳過註冊: ",
	["Beginning Transcript: "] = "開始記錄於: ",
	["You are not logging an encounter."] = "你不處於記錄狀態",
	["Ending Transcript: "] = "結束記錄於: ",
	["Logs will probably be saved to WoW\\WTF\\Account\\<name>\\SavedVariables\\Transcriptor.lua once you relog or reload the user interface."] = "記錄儲存於 WoW\\WTF\\Account\\<名字>\\SavedVariables\\Transcriptor.lua",
	["You are not logging an encounter."] = "你沒有記錄此次戰鬥",
	["Added Note: "] = "添加筆記於: ",
	...
	["|cff696969Idle|r"] = "|cff696969閒置|r",
	["|cffeda55fClick|r to start or stop transcribing an encounter."] = "|cffeda55f點擊|r開始/停止記錄戰鬥",
	["|cffeda55fCtrl-Click|r to add a bookmark note."] = "|cffeda55fCtrl-點擊|r增加一書籤筆記",
	["|cffFF0000Recording|r"] = "|cffFF0000記錄中|r",
	["!! Bookmark !!"] = "!! 書籤 !!",
	["Bookmark added to the current log."] = "書籤已添加至當前戰鬥記錄",
} end )
