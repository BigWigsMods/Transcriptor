...
do
	...
	elseif locale == "zhCN" then
		L["Remember to stop and start Transcriptor between each wipe or boss kill to get the best logs."] = "提示：为获得最佳记录，请在每次团灭或击杀首领后，先停止再重新启动 Transcriptor。"
		L["You are already logging an encounter."] = "你已经在记录一场战斗了。"
		L["Beginning Transcript: "] = "开始记录："
		L["You are not logging an encounter."] = "你当前没有在记录战斗。"
		L["Ending Transcript: "] = "停止记录："
		L["Logs will probably be saved to WoW\\WTF\\Account\\<name>\\SavedVariables\\Transcriptor.lua once you relog or reload the user interface."] = "日志可能会在重新登录或重载界面后，保存在 WoW\\WTF\\Account\\<账号名>\\SavedVariables\\Transcriptor.lua 中。你可以上传到github.com/BigWigsMods和Discord的地址,提供最新的BOSS数据。"
		L["All transcripts cleared."] = "所有记录已清除"
		L["You can't clear your transcripts while logging an encounter."] = "记录过程中无法清除记录。"
		L["|cff696969Idle|r"] = "|cff696969空闲|r"
		L["|cffeda55fClick|r to start or stop transcribing. |cffeda55fRight-Click|r to configure events. |cffeda55fAlt-Middle Click|r to clear all stored transcripts."] = "|cffeda55f点击|r 开始/停止记录。|cffeda55f右键点击|r 配置事件。|cffeda55fAlt+中键点击|r 清除所有记录。"
